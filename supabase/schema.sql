...
-- le client définit lui-même son mot de passe lors de l'activation
...
-- le client définit lui-même son mot de passe à l'inscription)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- RPC : activation d'un compte en attente par le client,
-- qui choisit lui-même son mot de passe
-- ------------------------------------------------------------
